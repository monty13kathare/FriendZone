        ...
        >
            <div className="bg-white text-gray-900 rounded-lg shadow-lg p-6 w-full max-w-sm sm:max-w-md lg:max-w-lg mx-4 sm:mx-auto">
                ...
                <div className="flex justify-between mt-6 space-x-2">
                    <button
                        onClick={onClose}
                        className="w-full sm:w-auto px-4 py-2 bg-gray-200  text-gray-800  hover:bg-gray-300 transition"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={handleLogout}
                        className="w-full sm:w-auto px-4 py-2 bg-red-500 rounded-lg text-gray-900 hover:bg-red-600 transition flex items-center justify-center"
                    >
